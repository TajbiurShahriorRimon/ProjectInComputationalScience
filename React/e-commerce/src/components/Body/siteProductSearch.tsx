...
class SiteProductSearch extends Component<any, any>{
    ...
    async componentDidMount() {
        const resp = await axios.get(`${base_url}products/`+window.location.pathname.split("/").pop());
                    ...
                    <div className="col-lg-3 mb-5">
                        <Card style={{ width: '18rem' }} className="box">
                            ...
                            <Card.Body>
                                ...
                                <Link to={`/product/productDetails/`+item[0]}>
